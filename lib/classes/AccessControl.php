<?php
/**
 * Access Control to MPO REST API
 *
 * Extend the authentication system to create a robust access control system.
 * It also restricts api documentation based on the same.
 *
 * See: http://restler3.luracast.com/examples/_010_access_control/readme.html
 *
 * It is a problem with using name space for AccessControl.
...
class AccessControl implements iAuthenticate {
  ...
  public function __isAllowed() {
    $roles = mpo()->get_config( 'access.keys', array() );
